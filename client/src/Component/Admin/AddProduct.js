...
function AddProduct() {
  ...
  return (
    <Container fluid className="addproduct mx-0 px-0 ">
      <Row className="px-0 mx-0">
        ...
        <Col lg={9} className="mx-0 px-0 cot2">
          ...
          <Form>
            <Container fluid className="mx-0" style={{ paddingLeft: "3px" }}>
              ...
              <Row>
                <FormGroup>
                  ...
                  <input
                    type="file"
                    name="imageproduct"
                    class="custom-file-input ms-3"
                    onChange={onImageChange}
                  />
                </FormGroup>
              </Row>
              <Row>
                <FormGroup className="ms-3 mt-5">
